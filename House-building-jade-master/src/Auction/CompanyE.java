...
public class CompanyE extends Agent {


    // The budget left for this bidder
    private int myPrice=800;


    // Building and Price of CompanyC

    String[] Building = {"Floors", "Walls", "Roof"};
    ...
    private String evaluateAction(String cfp) {
        ...
        if((myPrice < itemPrice) && (!currentBidder.equals(this.getAID().toString())) && chooseAuct)
        {
